...
ax.text(6.5,3e-11  ,"ADMX sidecar",fontsize=13,color="black",rotation=0,ha='center', va='center')
ax.text(4.1,1.1e-11,"ADMX sidecar",fontsize=13,color="black",rotation=0,ha='center', va='center')

ax.text(1.3 ,1e-14    ,"CAPP",size=12)
ax.text(2.35,2e-14    ,"CAPP",size=12)
ax.text(3.1 ,4e-14    ,"CAPP",size=12)
ax.text(5   ,1.1e-14  ,"CAPP",size=12)
ax.text(0.7 ,1.9e-14  ,"ADMX",size=12,ha='center', va='center')
ax.text(2   ,8.87e-13 ,"RBF" ,size=12)
ax.text(1.4 ,9e-14    ,"UF"  ,size=12)
ax.text(2   ,1.5e-10  ,"CAST",size=15)
